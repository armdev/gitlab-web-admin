...
public class GitlabAPI {
     ...
     * @throws IOException
     */
    public List<GitlabTrigger> getTriggers(Integer projectId) throws IOException {
        String tailUrl = GitlabProject.URL + "/" + sanitizeProjectId(projectId) + GitlabTrigger.URL;
        return retrieve().getAll(tailUrl, GitlabTrigger[].class);
    }
     ...
     * @param buildId The build's Id //armen
     * @return 
     * @throws IOException on gitlab api call error
     */
